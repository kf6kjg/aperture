...
WhipURI::WhipURI(const std::string &url)
{
	...
	if (uri.substr(0, 7) != "whip://")
		throw std::runtime_error("Invalid whip URL.  Must start with whip://");
	...
	if (userAndHost.size() != 2)
		throw std::runtime_error("Invalid whip URL, missing @");
	...
	if (hostAndPort.size() != 2)
		throw std::runtime_error("Invalid whip URL, missing : between host and port");
